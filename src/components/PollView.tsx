...
export const PollOptionView = ({
  ...
  const image = pollOptionView.imageUrl
    ? "http://localhost:8080/pollOptionImages/" + pollOptionView.imageUrl
    : null;
    ...
    >
      ...
      <div>
        ...
        <div className="p-4 flex flex-col justify-between relative z-10">
          ...
          <h3
            className={
              "font-semibold mb-2 text-white text-xl flex items-center"
            }
          >
